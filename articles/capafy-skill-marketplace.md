---
title: "Capafy — AIスキルをクローズドで販売できるマーケットプレイスが登場"
emoji: "🛒"
type: "tech"
...
**Capafy**は、Claude Code / Codex / OpenClaw などで動くAIエージェントSkillを売買できるマーケットプレイスです。2026年5月に登場したばかりで、既存のSkillマーケットと大きく異なる点が一つあります。
...
詳細は公式サイト [capafy.ai](https://capafy.ai/) で確認できます。
