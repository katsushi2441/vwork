...
description: "Nvidiaがソフトバンク系データセンターへ15億ドルを投資しOpenAIのインフラを支援するニュースや、Qwen3.8-27BがDeepSeek V4等と肩を並べるベンチマーク結果、DuckDB v2.0のプレビュー情報を紹介します。"
seo_title: "NvidiaのOpenAI投資とQwenの最新ベンチマーク"
head_keyword: "Nvidia OpenAI 投資"
published: true
---
