...
description: "AIxECの商品登録をHermes cronで定期実行し、Claude Code OAuthがジャンルを選定、Ollamaが商品を評価してAIxECへ登録するパイプラインをバイブコーディングで構築した記録。"
date: 2026-05-23
tags: [AIxEC, バイブコーディング, Hermes, Ollama, 自動化]
status: published
layout: default
