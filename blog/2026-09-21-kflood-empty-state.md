---
title: "ハザードマップに「いま」を足した——気象警報・避難所の開設状況・発令の記録を住所ひとつで"
title_aixsns: "ハザードマップに気象警報と避難情報を足した。出ていないときもそう書く"
title_hatena: "ハザードマップに気象警報を足す——同じデータでも画面が違えば別の道具になる"
title_blogger: "ハザードマップで差が出たのは「警報が出ていないとき」の表示だった"
date: 2026-09-21
status: published
tags: [AI, オープンデータ, 製品開発, 防災, バイブコーディング]
description: "Kurage洪水・内水ハザードマップに気象警報や避難所の開設状況などの新機能を追加しました。自治体の防災ポータルを比較した結果、住所ごとに「いま」の情報を束ねる層と、情報がないことを明示するUIの重要性を分析しています。"
seo_title: "Kurage洪水・内水ハザードマップの新機能と防災UIの考察"
head_keyword: "ハザードマップ 開発"
---
