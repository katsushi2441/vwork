...
[VWork](https://exbridge.jp/vwork.html) は、VS Code とAIエージェントの作業環境をお客様のPCに作り、**経営者がAIと会話しながら業務改善ツールを作れる状態**にするフレームワークです。この kinvoice は、そこで作れるようになる「小さな実用ツール」がどんなものかの実例です。
