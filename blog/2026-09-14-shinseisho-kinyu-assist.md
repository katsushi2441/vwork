...
status: published
tags: [AI, 業務効率化, 行政, DX]
description: "名古屋市の申請様式4,024件を調査した結果、オンライン完結できるのはわずか26.9%でした。WordやExcel等のオフィス文書への対応や、書式を維持したままAIで空欄を埋める技術の必要性について解説します。"
seo_title: "行政手続きのオンライン化と様式維持の課題"
head_keyword: "行政手続き オンライン化"
---
