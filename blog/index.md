...
seo_title: "公開データ活用とシステム開発の実践知"
head_keyword: "オープンデータ 活用"
---
...
- [義務化を3つ調べたら、国はぜんぶ無料の道具を配っていた——足りないのは記録だけだった](2026-09-25-gimuka-3-kiroku.html)
- [「国会トラッカー」は月間0回しか検索されていなかった——28ページの題名を実測で付け直した話](2026-09-25-kokkai-tracker-title-seo.html)
- [質問主意書と答弁書を本文までことばで引けるようにした——「お答えすることは困難」は答弁書の53%にあった](2026-09-23-shitsumon-shuisho-assist.html)
- [衆議院 選挙区289を1ページずつ——小選挙区ダッシュボード（土砂災害・避難所・訪問介護・一票の格差）を公開しました](2026-09-23-shugiin-senkyoku-dashboard.html)
- [ケアマネ事業所は1年半で3,146か所が公表データから消えた——訪問介護は3,242か所。差し引きの数字では見えない](2026-09-22-houmon-kaigo-caremane-opendata.html)
- [障害者グループホームは4年半で1.6倍。同じ期間に入所施設は1.03倍のままだった](2026-09-22-shougaisha-group-home-opendata.html)
- [放課後等デイサービスは4年半で1.7倍になった——同じ期間に3,114か所が公表データから消えている](2026-09-21-houkago-day-service-opendata.html)
- [就労継続支援A型は本当に減ったのか——公開データの「増えている」を信じずに数えた](2026-09-21-shuro-a-gata-opendata.html)
- [作り終えてから「これPHPだけでいいのでは」と言われた——バックエンドが要るかどうかの見分け方](2026-09-21-php-was-enough.html)
- [空の枠に何を書くかで、防災の道具は別物になる——他市の画面と比べて、4つ足した半日](2026-09-21-kflood-empty-state.html)
- [「発言601件」と表示する寸前で手が止まった——数え方ひとつで、道具は人を誤解させる](2026-09-14-giin-hatsugen-log.html)
- [申請様式4,024件のうち、オンラインで終わるのは26.9%だった](2026-09-14-shinseisho-kinyu-assist.html)
- [会社案内リーフレットを、元エステサロン経営者と元不動産経営者に直された——AIが書いた「正しい会社案内」が、売る人には刺さらなかった3つの理由](2026-09-11-company-leaflet-advised-by-owners.html)
- [名古屋の1時間104.5ミリ、ハザードマップは当たっていたのか——氾濫した矢田川・植田川・天白川の流域を、国の洪水想定・市の内水想定・24件の発令記録で突き合わせた](2026-09-09-nagoya-flood-hazardmap-check.html)
- [「通報アプリ」は検索されていなかった——名古屋市の通報窓口を1つの入口にまとめる『Kurage 通報先ナビ』を1日で作って出品するまで](2026-09-07-kecnavi-emergency-contact-navigator.html)
- [「テキスト情報の無いPDF」を見つけてから3時間で、note記事・解説動画・意見エッセイの3本を出した——考察の多形態展開もAIでやる](2026-09-06-gyosei-pdf-three-formats.html)
- [「区域外です」と答えるシステムが、いちばん危ない——津波浸水想定マップを作って、東京都で手が止まった話](2026-09-06-ktsunami-inundation-map.html)
- [「いちばん近い避難所」を出すシステムは、危ない——避難所まで徒歩何分かを返すサービスを作って、災害種別で絞る設計にした話](2026-09-05-krefuge-evacuation-map.html)
- [商圏分析システムの部品を組み替えて、土砂災害ハザードマップの判定サービスを1日で作った——検索需要を先に実測して「作るもの」を決めた記録](2026-09-05-khazard-hazard-map.html)
...
- [広聴AIをOpenAIキーなしで動かした——意見データを一切外に出さない完全ローカル構成の実測（デモ・導入キットつき）](2026-09-01-kouchou-ai-local.html)
- [住所を入れると徒歩10分圏の人口が出る——商圏分析システム「Kurage 商圏分析」を作って公開しました（買い切り55,000円）](2026-09-01-kshoken-launch.html)
- [商圏分析は無料でできる——QGISと国の統計データだけで出店エリアの人口・競合を出す方法](2026-09-01-shoken-bunseki-qgis-free.html)
- [LibreDeskを日本語で使う——メール・チャット・ヘルプセンターが1つになったオープンソースのヘルプデスク](2026-08-31-libredesk-intro.html)
- [翻訳率99.7%でも画面は壊れていた——OSSの日本語化で25か所のプレースホルダ崩れを見つけて本家へPRを出した記録](2026-08-31-libredesk-japanese.html)
- [英語基準のSEOツールは日本語サイトを誤判定する——タイトルを全角で数える診断ツールと、その入手経路4つ](2026-08-31-kseo-japanese-seo.html)
- [IT顧問契約の類似サービスを調べてみた——情シス代行・ヘルプデスク代行・常駐、8つの型と費用の幅](2026-08-30-it-komon-similar-services.html)
- [エンジニアを雇えない会社が、情報システム部門を持つ方法——AI-IT顧問という月15時間の契約を作りました](2026-08-30-ai-it-komon.html)
- [日本の買い切りツールを英語圏で売る——Whop出品の実務と、翻訳すべきだったもの](2026-08-28-whop-english-launch.html)
...
- [星23,700の優れたCRMが、日本で誰にも使われていない理由——日本語ファイルが無いだけでした。全2,392キーを訳して導入キットにした話](2026-08-24-krayin-japanese-kit.html)
- [VPSを持っていない会社は、無料CRMに移れない——共有レンタルサーバーにEspoCRMを立てて、500エラーの原因3つを手順書にした話](2026-08-24-espocrm-shared-server.html)
- [ログイン情報ごと公開しました——業務システムとOSSのデモ17件を、問い合わせなしで触れる場所を作った話](2026-08-24-demo-site-open.html)
- [その月額、いつまで払いますか——SaaSとパッケージのライセンス費を、OSS × AI開発でゼロにする話](2026-08-24-saas-oss-replacement.html)
- [OSSカタログを1,120件作っても、経営者には届かなかった——「AIで何ができるか」から引けるページを1,216枚、別ドメインに作った話](2026-08-23-ai-dekirukoto-2000pages.html)
...
- [顔認証打刻の勤怠システムを激安で入手する3つの方法——SaaSの月額固定費をやめる、買い切り55,000円という選択](2026-08-20-kkintai-kao-dakoku.html)
- [WordPressを「激安で安心」に置き換える——月2,400回検索されるヘッドレスCMSへ、実測で作った移行の道筋](2026-08-19-wordpress-headless-cms.html)
- [入札11万円のキーワードを見つけたので、AI名刺解析を1日で作った——Sansanが君臨する市場に買い切り55,000円で入る実測記録](2026-08-19-kaima-ai-ocr-meishi.html)
- [CRMが空っぽになるのは料金のせいじゃない——「入力ゼロCRM」を1日で作って出品するまでの実測記録](2026-08-19-kcrmagent-nyuryoku-zero.html)
- [急上昇キーワードの記事は流入ゼロ、「相手の言葉」の実話は2日で動いた——note・ジモティー・Brainを同じ物差しで実測した8月の途中経過](2026-08-18-trend-vs-jitsuwa.html)
