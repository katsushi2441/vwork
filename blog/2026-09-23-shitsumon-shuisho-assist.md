...
description: "質問主意書と答弁書の本文まで言葉で検索できるツールを紹介します。過去の国会での論点や政府の回答を1画面で比較でき、「お答えすることは困難」という定型句が答弁書の53%に含まれる実態も可視化できます。"
seo_title: "質問主意書と答弁書を本文まで検索できるツール"
head_keyword: "質問主意書 検索"
---
